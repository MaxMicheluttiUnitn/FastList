...
// An example of the use of FastList's cool functionalities
int main(){
    FastList<int> my_list = FastList<int>();
    my_list.enqueue(1);
    my_list.enqueue(2);
    my_list.enqueue(3);
    ...
    FastList<int> other_list=FastList<int>(my_list);
    ...
    FastList<int> new_list = FastList<int>();
    new_list.enqueue(2);
    new_list.enqueue(1);
    new_list.enqueue(2);
    new_list.enqueue(3);
    ...
    res.dequeue();
    for(FastIter iter=res.begin();iter!=res.end();iter++){
        new_list.merge(*iter);
    }
    cout<<"New List: "<<new_list<<endl;
    ...
    FastList<int> new_cool_list = FastList<int>();
    ...
    FastList<int> wow = {1,3,7,11,2,0,-1};
    cout<<"Wow: "<<wow<<endl;
